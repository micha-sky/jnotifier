package io.dope.jnotifier.config;
...
@Configuration
@EnableMongoRepositories("io.dope.jnotifier.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("io.dope.jnotifier.config.dbmigrations");
